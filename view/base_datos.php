...
<body>
        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary btn-duplicar-duplicar" data-toggle="modal"
                    ...
                    <td>
                        <button type="button" class="btn btn-primary btn-nuevaIncapacidad"  data-toggle="modal"
                            data-target="#nuevaIncapacidad" data-cedula="<?= htmlspecialchars($persona['Cedula']); ?>"
                            data-fechacontrato="<?= htmlspecialchars($persona['Fechacontrato']); ?>">
                            Ver
                            <i class="bi bi-person-plus"></i>
                        </button>
    ...
    <!-- <?php include 'modal_nuevaIncapacidad.php'; ?> -->
    ...
    <script src="../controller/js/nuevaIncapacidad.js"></script>
