<?php include '../model/consu_base_datos.php' ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <tr>
                    <?php if (!empty($personas)): ?>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($persona['Eps']); ?></td> <!-- Ahora debería funcionar -->
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-edit" data-toggle="modal"
                                    ...
                                    data-eps="<?= htmlspecialchars($persona['Eps']); ?>"
                                    data-empresa="<?= htmlspecialchars($persona['Empresa']); ?>"
                                    data-area="<?= htmlspecialchars($persona['Areatrabajo']); ?>"
                                    data-fecha="<?= htmlspecialchars($persona['Fechacontrato']); ?>">
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-duplicar" data-toggle="modal"
                                    ...
                                    data-area="<?= htmlspecialchars($persona['Areatrabajo']); ?>"
                                    data-fecha="<?= htmlspecialchars($persona['Fechacontrato']); ?>">
                                    Duplicar <i class="bi bi-person-plus"></i>
                                </button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
